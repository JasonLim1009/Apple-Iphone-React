...
const DisplaySection = () => {
  ...
  return (
    <Section>
      <MainTitle>
        massively <br /> more Pro.
      </MainTitle>
      <TextBlockRight>
        <Title>Up to 4x the resolution.</Title>
        <Text>
      ...
      <TextBlockLeft ref={container}>
        <Title>The picture of versatility.</Title>
        <Text>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit.
          Necessitatibus dignissimos ipsam.
        </Text>
      ...
      <TextContainer>
        <MovingText ref={textOne}>Much more detail.</MovingText>
        <MovingText ref={textTwo}>In much less light.</MovingText>
      </TextContainer>
    </Section>
  );
};
